...
<html>
  ...
  <body>
		<table>
			...
			<?php
				$table = mysqli_query($conn, "SELECT id, kemiringan, curahhujan, kelembaban, pergeseran, waktu FROM node1 order by id desc limit 0,15"); //nodemcu_ldr_table = Youre_table_name
