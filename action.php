        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="data view 2.php" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Data View
          </a>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="action.php">Lecture</a></li>
            <li><a class="dropdown-item" href="action.php">Student</a></li>
          </ul>
        </li>  
